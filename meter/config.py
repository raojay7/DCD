...
def config():
    ...
    data_root = ""
    log_dir = "result_39slurm"
    per_gpu_batchsize = 0  # you should define this manually with per_gpu_batch_size=#
    num_gpus = 8
    num_nodes = 1
    load_path=""
    # load_path = "meter_clip16_288_roberta_flickr.ckpt"
    # load_path = "mse_wsoft_8_64_f30k.ckpt"
    num_workers = 8
    precision = 32
    # teacher_path="meter_clip16_288_roberta_flickr.ckpt"
    useHNM = True
    useSucc=True
    useTeacher = True
